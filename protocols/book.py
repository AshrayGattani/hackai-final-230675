...
from .query import ClothingArticle  # Import the ClothingArticle class from the previous code
...
@cloth_book_proto.on_message(model=QueryClothingRequest, replies=QueryClothingResponse)
async def handle_clothing_query_request(ctx: Context, sender: str, msg: QueryClothingRequest):
    articles = {
...
@cloth_book_proto.on_query(model=GetTotalClothingQueries, replies=TotalClothingQueries)
